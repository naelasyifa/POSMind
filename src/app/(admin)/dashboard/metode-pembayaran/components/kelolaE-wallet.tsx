...
import EditEWallet from './editE-wallet'
...
export default function KelolaEWallet({ isOpen, onClose }: KelolaProps) {
  ...
  const handleSaveEdit = (updatedEWallet: any) => {
    setData((prev) =>
      prev.map((item) => (item.id === selectedEWallet.id ? { ...item, ...updatedEWallet } : item)),
    )
  }
      ...
      <div className="fixed inset-0 flex items-center justify-center z-[999]">
        ...
        >
          ...
          <div className="flex justify-between items-center px-6 pt-6 pb-6">
            <h2 className="text-xl font-semibold">Kelola Metode Pembayaran E Wallet</h2>
