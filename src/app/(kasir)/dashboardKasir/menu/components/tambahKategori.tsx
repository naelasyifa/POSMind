...
interface AddCategoryProps {
  isOpen: boolean
  onClose: () => void
  onAdd: (newCategory: { name: string; icon: string }) => void
}

export default function TambahKategori({ isOpen, onClose, onAdd }: AddCategoryProps) {
  ...
  const handleSubmit = () => {
    ...
    onAdd({ name: newKategori, icon: selectedIcon })
    setNewKategori('')
